...
export function setupGitHubAlerts(): void {
    ...
    blockquotes.forEach((blockquote, index) => {
        ...
        if (isMathType) {
            ...
            iconElement.className = 'github-alert-icon';
            iconElement.innerHTML = getAlertIconSvg(alertType);
...
function getAlertIconSvg(alertType: string): string {
    ...
    return iconMap[alertType] || iconMap.note;
}
